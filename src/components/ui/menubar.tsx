...
>(({ className,children, title, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex justify-between h-10 items-center space-x-1  border border-stone-200 bg-white p-1 dark:border-stone-800 dark:bg-stone-950",
      className
    )}
    {...props}
  >
      <div className="menubar-left flex items-center space-x-2 ml-2">
          <h3 className="font-bold">{title}</h3>
      </div>
      <div className="menubar-right flex items-center space-x-4">
          {children}
      </div>
  </MenubarPrimitive.Root>
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-1 py-1 text-sm font-medium outline-none focus:bg-stone-100 focus:text-stone-900 data-[state=open]:bg-stone-100 data-[state=open]:text-stone-900 dark:focus:bg-stone-800 dark:focus:text-stone-50 dark:data-[state=open]:bg-stone-800 dark:data-[state=open]:text-stone-50",
      className
    )}
    {...props}
  />
